        ...
        <div className="mx-auto max-w-6xl px-4 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-56 rounded-xl border border-white/10 bg-[#111827] p-2 shadow-xl text-slate-200"
              >
                <DropdownMenuItem
                  className="flex items-center gap-2 rounded-lg p-2.5 text-sm cursor-pointer hover:bg-white/5 focus:bg-white/5"
                ...
                {canModerate && (
                  <DropdownMenuItem
                    className="flex cursor-pointer items-center gap-2 rounded-lg p-2.5 text-sm hover:bg-white/5 focus:bg-white/5"
                ...
                <DropdownMenuItem
                  className="flex items-center gap-2 rounded-lg p-2.5 text-sm cursor-pointer text-rose-400 hover:bg-rose-500/10 focus:bg-rose-500/10 focus:text-rose-400"
